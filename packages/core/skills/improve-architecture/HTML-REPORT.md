...
- **Decision-issue callout** (if applicable) — one line in an amber-tinted box, e.g. _"contradicts decision issue #42 — but worth reopening because…"_ (we record decisions as GitHub issues, not in-repo ADRs).
